...
<div class="container" id="fore-particles">
    <svg class="moko-404" viewbox="0 0 500 400">
        ...
        <ellipse cx="280.8" cy="116.9" class="moko-404__c" rx="4.5" ry="4.7"
        ...
        <path d="M269 131.5s1.8 25-1.6 26C263 159 252 149 252 149l-3-9.5s13.4 10.3 14.6 10.3c2.2 0-1-15.5-1-15.5"
            class="moko-404__b" />
        <ellipse cx="273.2" cy="118.3" class="moko-404__c" rx="4.5" ry="4.7"
        ...
        <ellipse cx="218.1" cy="118.3" class="moko-404__c" rx="4.7" ry="4.5"
        ...
        <path class="pupilL1 pupilL4 moko-404__l"
        ...
        <path class="pupilR3 moko-404__l"
            d="M269.1,96.89s1.43,0,3.19,0,3.19,0,3.19,0-1.43-.05-3.19-.05-3.19,0-3.19.05" />
    </svg>
    <p class="small text-center mx-auto mb-4">¡la pagina que busca no esta disponible!</p>
...
<style>
    ...
    * {
    ...
    body {
        ...
        background-image: linear-gradient(rgb(227 188 255 / 5%), rgb(151 151 151 / 92%)), url(../resources/fondo.jpg);
    }
