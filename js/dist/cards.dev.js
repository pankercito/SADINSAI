        ...
        buttons: {
          cambio: {
            ...
            action: function action() {
              var germain = document.getElementById('germain'); // Creamos un objeto con los datos del formulario
      ...
      a: {
        ...
        action: function action() {
          $.ajax({
            ...
            success: function success(params) {
              if (jeisonXD(params)) {
                //verificar si lo devuelto es jeison
