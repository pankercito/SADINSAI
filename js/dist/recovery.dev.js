        ...
        setTimeout(function () {
          switch (res) {
            case "¡La CI ingresada ya está registrada!":
              ...
              setTimeout(function () {
                boton.innerHTML = "correcto"; // formulario de registro 
                ...
                $.confirm({
                  ...
                  onContentReady: function onContentReady() {
                    ...
                    var help = document.getElementById("helpId1"); // VERIFICACION DE PIN
                    ...
                    var self = this;
                    var h = false; // desactivar boton enviar

                    this.buttons.registrar.disable(); // colores de verificacion y activacion de input password 
                  ...
                  buttons: {
                    registrar: {
                      ...
                      action: function action() {
                        ...
                        fom.append("ci", ci); // registro con ajax
