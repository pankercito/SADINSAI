...
<div class="mb-3 row col align-items-baseline mx-2">
    ...
    <div class="col">
        ...
        <input type="date" class="form-control" name="fechaingreso" id="fechaingreso" placeholder="Ej: 12/12/2012">
    </div>
    <div class="col">
        <label for="organismos" class="col-form-label">tiempo de servicio en otros organismos publicos</label>
        <input type="text" class="form-control" name="organismos" id="organismos" placeholder="Ej: 1 año">
    </div>
    <div class="col">
...
<div class="mb-3 row col align-items-baseline mx-2">
    ...
    <div class="col">
        ...
        <input type="text" name="cantidad" placeholder="dias" id="observaciones" class="form-control">
    </div>
    <div class="col">
        <label for="incorporacion">fecha de incorporacion</label>
        <input type="date" name="incorporacion" placeholder="12-12-2012" id="observaciones" class="form-control">
    </div>
    <div class="col">
        <label for="licencia">periodo de licencia</label>
        <input type="text" name="licencia" id="licencia" class="form-control" placeholder="dias">
    </div>
</div>
