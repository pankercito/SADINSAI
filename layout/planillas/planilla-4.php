...
<form action="../php/solisPlanlillas.php" method="post">
    ...
    <div class="mb-3 row col aling-items-baseline mx-2">
        ...
        <div class="col">
            ...
            <input type="text" class="form-control" name="celphonN" id="ubicacion" placeholder="Name">
        </div>
    </div>
    <div class="col">
        <h6 class="text-center">
    ...
    <div class="mb-3 row col align-items-baseline mx-2">
        <div class="col">
            ...
            <input type="text" class="form-control" name="nombreBene" id="fechaingreso" placeholder="Name">
        </div>
        <div class="col">
            <label for="fechaingres" class="col-form-label">cedula</label>
            <input type="text" class="form-control" name="ciBene" id="fechaingres" placeholder="Name">
        </div>
        <div class="col">
            <label for="fechaingresos" class="col-form-label">Parentesco</label>
            <input type="text" class="form-control" name="parent" id="fechaingresos" placeholder="Name">
        </div>
        <div class="col">
    ...
    <div class="mb-3 row col align-items-baseline mx-2">
        <div class="col">
            ...
            <input name="diagnostico" id="Diagnostico" class="form-control" type="text" placeholder="texto">
        </div>
        <div class="col">
            <label for="Observaciones">Observaciones</label>
            <input name="observaciones" id="Observaciones" class="form-control" type="text" placeholder="texto">
        </div>
    </div>
    <div class="col">
        <input type="text" class="d-none" value="4" name="formtipo">
        <button type="submit" onclick="enviarInputsDesactivados()" class="btn btn-success btn-lg">procesar</button>
    </div>
</form>